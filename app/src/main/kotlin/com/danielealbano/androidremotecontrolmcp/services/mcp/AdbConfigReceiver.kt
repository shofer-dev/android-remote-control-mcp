 ...
 *   --es edge_host "phones.justceo.ai" \
 *   --es gateway_url "ws://phone-gateway.justceo.svc.cluster.local:8025/ws/phone" \
 *   --es enrolment_code "one-time-code" \
 *   --ez connector_auto_start true
 *
 * # gateway_url (full ws://…/ws/phone or wss://…/ws/phone) takes precedence over edge_host
 * # (which resolves to wss://<edge_host>/ws/phone); at least one is required. A configure
